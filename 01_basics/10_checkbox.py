...
print(f'[INFO] Liczba wszystkich konturow: {len(contours)}')

img_cnt = cv2.drawContours(image=img.copy(), contours=[contours[5]], contourIdx=-1, color=(0, 255, 0), thickness=2)
