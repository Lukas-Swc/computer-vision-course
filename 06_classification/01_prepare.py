...
cls_1_names = [fname for fname in cls_1_names if fname.split('.')[2].lower() in ['jpg', 'png', 'jpeg']]
cls_2_names = [fname for fname in cls_2_names if fname.split('.')[2].lower() in ['jpg', 'png', 'jpeg']]
